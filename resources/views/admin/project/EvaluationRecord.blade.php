            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                        <tr>
                            ...
                            <td style="text-align: center; padding-top: 40px;"><input type="checkbox" name="Knowledge" id="Below" value=""><div class="Emoji" id="control-me"></div></td>
                        </tr>
                        <tr>
                            <td style="height: 100px;">
                        ...
                        <tr>
                            <td style="height: 100px;">
                                <b style="font-size: 25px;">Overall Appraisal Rating</b>
                            </td>
