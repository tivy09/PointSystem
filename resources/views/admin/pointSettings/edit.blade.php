...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pointSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.point-settings.update", [$pointSetting->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="exchange_rate">{{ trans('cruds.pointSetting.fields.exchange_rate') }}</label>
                <input class="form-control {{ $errors->has('exchange_rate') ? 'is-invalid' : '' }}" type="number" name="exchange_rate" id="exchange_rate" value="{{ old('exchange_rate', $pointSetting->exchange_rate) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('earn_amount') ? 'is-invalid' : '' }}" type="number" name="earn_amount" id="earn_amount" value="{{ old('earn_amount', $pointSetting->earn_amount) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('enable') ? 'is-invalid' : '' }}" type="number" name="enable" id="enable" value="{{ old('enable', $pointSetting->enable) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('display') ? 'is-invalid' : '' }}" type="number" name="display" id="display" value="{{ old('display', $pointSetting->display) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('point_period') ? 'is-invalid' : '' }}" type="number" name="point_period" id="point_period" value="{{ old('point_period', $pointSetting->point_period) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('point_status') ? 'is-invalid' : '' }}" type="number" name="point_status" id="point_status" value="{{ old('point_status', $pointSetting->point_status) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('point_activate_period') ? 'is-invalid' : '' }}" type="number" name="point_activate_period" id="point_activate_period" value="{{ old('point_activate_period', $pointSetting->point_activate_period) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('point_activate_date') ? 'is-invalid' : '' }}" type="text" name="point_activate_date" id="point_activate_date" value="{{ old('point_activate_date', $pointSetting->point_activate_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('earn_rate') ? 'is-invalid' : '' }}" type="number" name="earn_rate" id="earn_rate" value="{{ old('earn_rate', $pointSetting->earn_rate) }}" step="0.01">
