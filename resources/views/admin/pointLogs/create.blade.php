    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.point-logs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prize') ? 'is-invalid' : '' }}" type="number" name="prize" id="prize" value="{{ old('prize', '0') }}" step="1">
                @if($errors->has('prize'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('voucher') ? 'is-invalid' : '' }}" type="number" name="voucher" id="voucher" value="{{ old('voucher', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', 'null') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('point_amount') ? 'is-invalid' : '' }}" type="number" name="point_amount" id="point_amount" value="{{ old('point_amount', '0') }}" step="1">
