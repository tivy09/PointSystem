    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.points.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pending_point') ? 'is-invalid' : '' }}" type="number" name="pending_point" id="pending_point" value="{{ old('pending_point', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('activate_point') ? 'is-invalid' : '' }}" type="number" name="activate_point" id="activate_point" value="{{ old('activate_point', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expired_point') ? 'is-invalid' : '' }}" type="number" name="expired_point" id="expired_point" value="{{ old('expired_point', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('activate_date') ? 'is-invalid' : '' }}" type="text" name="activate_date" id="activate_date" value="{{ old('activate_date') }}">
