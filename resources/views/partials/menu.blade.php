<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            @endcan
            @can('campany_controller')
            <!-- Compnay Controller -->
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#">
                    <i class="fa-fw nav-icon">
                ...
                @can('project_manager')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.Project.Evaluation') }}" class="nav-link">
                            ...
                            </i> Project Evaluation </a>
                    </li>
                @endcan
                @can('project_employee')
                    <li class="nav-item">
                ...
                <ul class="nav-dropdown-items">
                    ...
                    <li class="nav-item">
                        <a href="{{ route("admin.calendar.index") }}" class="nav-link {{ request()->is('admin/events') || request()->is('admin/events/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-cogs nav-icon"></i>{{ trans('cruds.event.title') }}
                        </a>
                    </li> 
                </ul>
            </li>
